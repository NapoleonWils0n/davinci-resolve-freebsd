...
Go to the Davinci Resolve website and click the "Davinci Resolve Free Download Now" button
...
the zip file has a file size of 2.4 gigabytes so may take an hour or so to download depending on your download speed
