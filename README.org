...
link to [[file:freebsd/usr/local/etc/doas.conf][doas.conf]] in this repository
...
link to the [[file:freebsd/usr/local/etc/rc.d/ubuntu][ubuntu]] script in this repository
...
save the following code as two scripts called lunar and mantic
