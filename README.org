...
move the zip into the home directory in the chroot
...
#+begin_src sh
sudo apt install libinput-tools wayland-protocols qtwayland5 qt6-wayland wayland-utils adwaita-qt qt5ct
#+end_src
